...
everyone reading it and cuts the repeat questions mods handle by hand.

The asker can add `private: true` to keep an answer to themselves. That is
their call rather than the bot's: only they know whether their question gives
...
Anyone who wants the long form can ask a follow-up, or use the web page,
which never asks for brief.
